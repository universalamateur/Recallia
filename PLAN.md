...
Implemented MVP. This file is now a final status checklist, not the active work queue.
...
4. Click **Ask Recallia AI** to create a persisted draft and pending AI run.
...
- [x] Browser smoke test covers the full Loom path.
...
- [x] Ask Recallia AI returns deterministic suggested links in mock mode.
...
- [x] `npm run data:reset` clears local runtime data.
